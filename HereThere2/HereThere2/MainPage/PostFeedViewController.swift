...
class PostFeedViewController: BaseViewController, UITableViewDataSource, UITextFieldDelegate {
    ...
    @IBOutlet weak var pickedLo: UILabel!
    var count = 0
    var mar = 186
    ...
    override func viewDidLoad() {
        ...
        let rect = CGRect.init(origin: CGPoint.init(x: 1, y: 13), size: CGSize.init(width: 160, height: 121))
        ...
        self.addPicture.layer.addSublayer(layer);
        
        
        //addPicture.layer.borderColor = UIColor.gray.cgColor
        ...
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "완료", style: .plain, target: self, action: #selector(buttonPressed))
    ...
    @objc private func buttonPressed(_ sender: Any) { if sender is UIBarButtonItem {
...
extension PostFeedViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate{
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        imageView.topAnchor.constraint(equalTo: scrollView.topAnchor, constant: 28).isActive = true
        mar = mar + 170
    }
}
